...
export const Navigation = () => {
  ...
  const desktopLinks = [
    { href: "/", label: navLabels.home },
    { href: "/how-it-works", label: navLabels.howItWorks },
    { type: "dropdown", label: navLabels.services },
    { href: "/gallery", label: navLabels.gallery },
    { href: "/blog", label: navLabels.blog },
    { href: "/faq", label: navLabels.faq },
    // { href: "/contact", label: navLabels.contact },
        ...
        <nav className="max-w-7xl mx-auto px-6 xl:px-10 flex items-center justify-between gap-4 h-20">
          ...
          <div className="flex justify-start flex-shrink-0">
            <Link href="/" className="flex items-center group">
              <Logo tone={isLightState ? "dark" : "light"} imageUrl={settings.logoUrl} />
            </Link>
          </div>
